...
class SP_Widget_Staff_List extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'widget_staff_list widget_sp_staff_list', 'description' => __( 'A list of staff.', 'prosports' ) );
		parent::__construct('sp_staff_list', __( 'Staff List', 'prosports' ) . ' (' . __( 'ProSports', 'prosports' ) . ')', $widget_ops);
	}
	...
	function update( $new_instance, $old_instance ) {
		...
		// Filter to hook into
		$instance = apply_filters( 'prosports_widget_update', $instance, $new_instance, $old_instance, 'staff-list' );
	...
	function form( $instance ) {
		...
		// Action to hook into
		do_action( 'prosports_before_widget_template_form', $this, $instance, 'staff-list' );
		?>
		...
		<?php
		// Action to hook into
		do_action( 'prosports_after_widget_template_form', $this, $instance, 'staff-list' );
	}
}
