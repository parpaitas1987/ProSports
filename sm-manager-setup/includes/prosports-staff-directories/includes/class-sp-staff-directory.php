 ...
 *
 * The ProSports staff directory class handles individual staff directory data.
 *
...
class SP_Staff_Directory {
	...
	public function data( $admin = false ) {
		...
		$labels = apply_filters( 'prosports_directory_labels', array(
			'phone' => __( 'Phone', 'prosports' ),
			'email' => __( 'Email', 'prosports' ),
		));
