...
$defaults = array(
	...
	'link_phone' => get_option( 'prosports_staff_link_phone', 'yes' ) == 'yes' ? true : false,
	'link_email' => get_option( 'prosports_staff_link_email', 'yes' ) == 'yes' ? true : false,
	...
	'paginated' => get_option( 'prosports_directory_paginated', 'yes' ) == 'yes' ? true : false,
	'rows' => get_option( 'prosports_directory_rows', 10 ),
);
...
if ( $show_all_staff_link )
	$output .= '<a class="sp-staff-directory-link sp-view-all-link" href="' . get_permalink( $id ) . '">' . __( 'View all staff', 'prosports' ) . '</a>';
