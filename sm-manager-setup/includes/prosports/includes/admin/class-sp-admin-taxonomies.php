...
class SP_Admin_Taxonomies {
	...
	public function add_venue_fields() {
		...
		<div class="form-field">
			<label for="term_meta[sp_address]"><?php _e( 'Address', 'prosports' ); ?></label>
			...
			<p><?php _e( "Drag the marker to the venue's location.", 'prosports' ); ?></p>
		</div>
	<?php
	}
	...
	public function edit_venue_fields( $term ) {
		...
		$term_meta = get_option( "taxonomy_$t_id" ); ?>
		<tr class="form-field">
			<th scope="row" valign="top"><label for="term_meta[sp_address]"><?php _e( 'Address', 'prosports' ); ?></label></th>
			<td>
				...
				<span class="description"><?php _e( "Drag the marker to the venue's location.", 'prosports' ); ?></span></p>
			</td>
		</tr>
		<tr class="form-field">
			<th scope="row" valign="top"><label for="term_meta[sp_latitude]"><?php _e( 'Latitude', 'prosports' ); ?></label></th>
			<td>
		...
		<tr class="form-field">
			<th scope="row" valign="top"><label for="term_meta[sp_longitude]"><?php _e( 'Longitude', 'prosports' ); ?></label></th>
			<td>
	...
	public function taxonomy_columns( $columns ) {
		$columns['posts'] = __( 'Events', 'prosports' );
		return $columns;
	}
	...
	public function venue_columns( $columns ) {
		$new_columns          = array();
		$new_columns['sp_address'] = __( 'Address', 'prosports' );
		$new_columns['posts'] = __( 'Events', 'prosports' );
	...
	public function position_columns( $columns ) {
		$columns['posts'] = __( 'Players', 'prosports' );
		return $columns;
	}
	...
	public function role_columns( $columns ) {
		$columns['posts'] = __( 'Staff', 'prosports' );
		return $columns;
	}
