...
class SP_Meta_Box_Table_Data {
	...
	public static function table( $columns = array(), $usecolumns = null, $data = array(), $placeholders = array(), $adjustments = array(), $highlight = null ) {
		if ( is_array( $usecolumns ) )
			...
			$show_team_logo = get_option( 'prosports_table_show_logos', 'no' ) == 'yes' ? true : false;
		?>
		<input type="hidden" name="sp_highlight" value="0">
		<ul class="subsubsub sp-table-bar">
			<li><a href="#sp-table-values" class="current"><?php _e( 'Values', 'prosports' ); ?></a></li> | 
			<li><a href="#sp-table-adjustments" class=""><?php _e( 'Adjustments', 'prosports' ); ?></a></li>
		</ul>
		<div class="sp-data-table-container sp-table-panel sp-table-values" id="sp-table-values">
			<table class="widefat sp-data-table sp-league-table">
				<thead>
					<tr>
						<th class="radio"><span class="dashicons sp-icon-shield tips" title="<?php _e( 'Highlight', 'prosports' ); ?>"></span></th>
						<th><?php _e( 'Team', 'prosports' ); ?></th>
				...
				<tbody>
					...
					if ( is_array( $data ) && sizeof( $data ) > 0 ):
						...
						foreach ( $data as $team_id => $team_stats ):
							...
							<tr class="sp-row sp-post<?php if ( $i % 2 == 0 ) echo ' alternate'; ?>">
								...
								<td>
									<?php if ( $show_team_logo ) echo get_the_post_thumbnail( $team_id, 'prosports-fit-mini' ); ?>
									<span class="sp-default-value">
										<span class="sp-default-value-input"><?php echo $default_name; ?></span>
										<a class="dashicons dashicons-edit sp-edit" title="<?php _e( 'Edit', 'prosports' ); ?>"></a>
									</span>
									<span class="hidden sp-custom-value">
										...
										<a class="button button-secondary sp-cancel"><?php _e( 'Cancel', 'prosports' ); ?></a>
										<a class="button button-primary sp-save"><?php _e( 'Save', 'prosports' ); ?></a>
									</span>
								</td>
					...
					<tr class="sp-row alternate">
						<td colspan="<?php $colspan = sizeof( $columns ) + 2; echo $colspan; ?>">
							<?php printf( __( 'Select %s', 'prosports' ), __( 'Teams', 'prosports' ) ); ?>
						</td>
					</tr>
					<?php
					endif;
