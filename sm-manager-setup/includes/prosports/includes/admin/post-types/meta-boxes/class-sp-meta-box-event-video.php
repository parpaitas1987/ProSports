...
class SP_Meta_Box_Event_Video {
	...
	public static function output( $post ) {
		...
		<fieldset class="sp-video-embed">
			...
			<p><a href="#" class="sp-remove-video"><?php _e( 'Remove video', 'prosports' ); ?></a></p>
		</fieldset>
		<?php endif; ?>
		<fieldset class="sp-video-field hidden">
			<p><strong><?php _e( 'URL', 'prosports' ); ?></strong></p>
			<p><input class="widefat" type="text" name="sp_video" id="sp_video" value="<?php echo $video; ?>"></p>
			<p><a href="#" class="sp-remove-video"><?php _e( 'Cancel', 'prosports' ); ?></a></p>
		</fieldset>
		<fieldset class="sp-video-adder<?php if ( $video ): ?> hidden<?php endif; ?>">
			<p><a href="#" class="sp-add-video"><?php _e( 'Add video', 'prosports' ); ?></a></p>
		</fieldset>
		<?php
	}
