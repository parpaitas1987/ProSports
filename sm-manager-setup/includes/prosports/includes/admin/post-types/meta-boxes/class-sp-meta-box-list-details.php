...
class SP_Meta_Box_List_Details {
	...
	public static function output( $post ) {
		...
		<div>
			...
			<p><strong><?php _e( 'Grouping', 'prosports' ); ?></strong></p>
			<p>
			<select name="sp_grouping">
				<option value="0"><?php _e( 'None', 'prosports' ); ?></option>
				<option value="position" <?php selected( $grouping, 'position' ); ?>><?php _e( 'Position', 'prosports' ); ?></option>
			</select>
			</p>
			<p><strong><?php _e( 'Sort by', 'prosports' ); ?></strong></p>
			<p>
			<?php
			$args = array(
			...
			<p><strong><?php _e( 'Sort Order', 'prosports' ); ?></strong></p>
			<p>
			...
			<p><strong><?php _e( 'Players', 'prosports' ); ?></strong></p>
			<?php
