...
class SP_Meta_Box_Player_Details {
	...
	public static function output( $post ) {
		...
		?>
		<p><strong><?php _e( 'Number', 'prosports' ); ?></strong></p>
		<p><input type="text" size="4" id="sp_number" name="sp_number" value="<?php echo $number; ?>"></p>

		<p><strong><?php _e( 'Nationality', 'prosports' ); ?></strong></p>
		<p><select id="sp_nationality" name="sp_nationality" data-placeholder="<?php printf( __( 'Select %s', 'prosports' ), __( 'Nationality', 'prosports' ) ); ?>" class="widefat chosen-select<?php if ( is_rtl() ): ?> chosen-rtl<?php endif; ?>">
			<option value=""></option>
		...
		<p><strong><?php _e( 'Positions', 'prosports' ); ?></strong></p>
		<p><?php
		$args = array(
			...
			'values' => 'term_id',
			'placeholder' => sprintf( __( 'Select %s', 'prosports' ), __( 'Positions', 'prosports' ) ),
			'class' => 'widefat',
			'property' => 'multiple',
			'chosen' => true,
		);
		...
		<p><strong><?php _e( 'Current Teams', 'prosports' ); ?></strong></p>
		<p><?php
		$args = array(
			'post_type' => 'sp_team',
			...
			'values' => 'ID',
			'placeholder' => sprintf( __( 'Select %s', 'prosports' ), __( 'Teams', 'prosports' ) ),
		...
		<p><strong><?php _e( 'Past Teams', 'prosports' ); ?></strong></p>
		<p><?php
		$args = array(
			'post_type' => 'sp_team',
			'name' => 'sp_past_team[]',
		...
		$args = array(
			...
			'selected' => $season_ids,
			'values' => 'term_id',
			'placeholder' => sprintf( __( 'Select %s', 'prosports' ), __( 'Seasons', 'prosports' ) ),
			'class' => 'widefat',
			'property' => 'multiple',
			'chosen' => true,
		);
