	...
	public static function output( $post ) {
		...
		<div class="sp-instance">
			<ul id="sp_column-tabs" class="wp-tab-bar sp-tab-bar">
				<li class="wp-tab-active"><a href="#sp_performance-all"><?php _e( 'Performance', 'prosports' ); ?></a></li>
				<li class="wp-tab"><a href="#sp_metric-all"><?php _e( 'Metrics', 'prosports' ); ?></a></li>
				<li class="wp-tab"><a href="#sp_statistic-all"><?php _e( 'Statistics', 'prosports' ); ?></a></li>
			</ul>
			<?php
