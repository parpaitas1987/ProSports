...
class SP_Admin_CPT_Column extends SP_Admin_CPT {
	...
	public function edit_columns( $existing_columns ) {
		$columns = array(
			...
			'sp_key' => __( 'Key', 'prosports' ),
			'sp_equation' => __( 'Equation', 'prosports' ),
			'sp_precision' => __( 'Rounding', 'prosports' ),
			'sp_order' => __( 'Sort Order', 'prosports' ),
			'sp_description' => __( 'Description', 'prosports' ),
		);
		return apply_filters( 'prosports_column_admin_columns', $columns );
	}
