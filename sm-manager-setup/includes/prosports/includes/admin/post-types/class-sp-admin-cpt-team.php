...
class SP_Admin_CPT_Team extends SP_Admin_CPT {
	...
	public function edit_columns( $existing_columns ) {
		...
		$columns = array_merge( array(
			...
			'sp_icon' => '<span class="dashicons sp-icon-shield tips" title="' . __( 'Logo', 'prosports' ) . '"></span>',
			'title' => null,
			...
			'title' => __( 'Team', 'prosports' ),
		) );
		return apply_filters( 'prosports_team_admin_columns', $columns );
	}
