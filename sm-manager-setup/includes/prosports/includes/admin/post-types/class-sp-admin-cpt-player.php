...
class SP_Admin_CPT_Player extends SP_Admin_CPT {
	...
	public function edit_columns( $existing_columns ) {
		...
		$columns = array_merge( array(
			...
			'sp_number' => '<span class="dashicons sp-icon-tshirt tips" title="' . __( 'Number', 'prosports' ) . '"></span>',
			'title' => null,
		...
		return apply_filters( 'prosports_player_admin_columns', $columns );
	}
	...
	public function filters() {
		...
		$args = array(
			'show_option_all' =>  __( 'Show all positions', 'prosports' ),
