...
class SP_AJAX {
	...
	public function __construct() {
		...
		foreach ( $ajax_events as $ajax_event => $nopriv ) {
			add_action( 'wp_ajax_prosports_' . $ajax_event, array( $this, $ajax_event ) );

			if ( $nopriv ) {
				add_action( 'wp_ajax_nopriv_prosports_' . $ajax_event, array( $this, $ajax_event ) );
			}
		}
	}
	...
	public function countdown_shortcode() {
		...
		<div class="wrap sp-thickbox-content" id="sp-thickbox-event_calendar">
			<p>
				<label>
					<?php printf( __( 'Select %s:', 'prosports' ), __( 'Event', 'prosports' ) ); ?>
					<?php
					$args = array(
						'post_type' => 'sp_event',
						'name' => 'id',
						'values' => 'ID',
						'show_option_all' => __( '(Auto)', 'prosports' ),
						'show_dates' => true,
						'post_status' => 'future',
					);
			...
			<p>
				<label>
					...
					<?php _e( 'Display venue', 'prosports' ); ?>
				</label>
			</p>
			<p>
				<label>
					<input class="checkbox" type="checkbox" name="show_league">
					<?php _e( 'Display competition', 'prosports' ); ?>
				</label>
			</p>
			<p class="submit">
				<input type="button" class="button-primary" value="<?php echo sprintf( __( 'Insert %s', 'prosports' ), __( 'Shortcode', 'prosports' ) ); ?>" onclick="insertProSports('countdown');" />
				<a class="button-secondary" onclick="tb_remove();" title="<?php _e( 'Cancel', 'prosports' ); ?>"><?php _e( 'Cancel', 'prosports' ); ?></a>
			</p>
		</div>
		<?php
		self::scripts();
	...
	public function event_details_shortcode() {
		...
		<div class="wrap sp-thickbox-content" id="sp-thickbox-event_details">
			...
			<p class="submit">
				<input type="button" class="button-primary" value="<?php echo sprintf( __( 'Insert %s', 'prosports' ), __( 'Shortcode', 'prosports' ) ); ?>" onclick="insertProSports('event_details');" />
				<a class="button-secondary" onclick="tb_remove();" title="<?php _e( 'Cancel', 'prosports' ); ?>"><?php _e( 'Cancel', 'prosports' ); ?></a>
			</p>
		</div>
		<?php
	...
	public function event_results_shortcode() {
		...
		<div class="wrap sp-thickbox-content" id="sp-thickbox-event_results">
			...
			<p class="submit">
				<input type="button" class="button-primary" value="<?php echo sprintf( __( 'Insert %s', 'prosports' ), __( 'Shortcode', 'prosports' ) ); ?>" onclick="insertProSports('event_results');" />
				<a class="button-secondary" onclick="tb_remove();" title="<?php _e( 'Cancel', 'prosports' ); ?>"><?php _e( 'Cancel', 'prosports' ); ?></a>
			</p>
		</div>
		<?php
	...
	public function event_performance_shortcode() {
		...
		<div class="wrap sp-thickbox-content" id="sp-thickbox-event_performance">
			...
			<p class="submit">
				<input type="button" class="button-primary" value="<?php echo sprintf( __( 'Insert %s', 'prosports' ), __( 'Shortcode', 'prosports' ) ); ?>" onclick="insertProSports('event_performance');" />
				<a class="button-secondary" onclick="tb_remove();" title="<?php _e( 'Cancel', 'prosports' ); ?>"><?php _e( 'Cancel', 'prosports' ); ?></a>
			</p>
		</div>
		<?php
	...
	public function event_calendar_shortcode() {
		...
		<div class="wrap sp-thickbox-content" id="sp-thickbox-event_calendar">
			<p>
				<label>
					<?php printf( __( 'Select %s:', 'prosports' ), __( 'Calendar', 'prosports' ) ); ?>
					<?php
					$args = array(
			...
			<p>
				<label>
					<?php _e( 'Status:', 'prosports' ); ?>
					<?php
					$args = array(
						'name' => 'status',
						'show_option_default' => __( 'Default', 'prosports' ),
					);
			...
			<p>
				<label>
					<?php _e( 'Display link to view all events', 'prosports' ); ?>
					<input type="checkbox" name="show_all_events_link" id="show_all_events_link">
				</label>
			</p>
			<p class="submit">
				<input type="button" class="button-primary" value="<?php echo sprintf( __( 'Insert %s', 'prosports' ), __( 'Shortcode', 'prosports' ) ); ?>" onclick="insertProSports('event_calendar');" />
				<a class="button-secondary" onclick="tb_remove();" title="<?php _e( 'Cancel', 'prosports' ); ?>"><?php _e( 'Cancel', 'prosports' ); ?></a>
			</p>
		</div>
		<?php
	...
	public function event_list_shortcode() {
		...
		<div class="wrap sp-thickbox-content" id="sp-thickbox-event_list">
			...
			<p>
				<label>
					<?php _e( 'Date:', 'prosports' ); ?>
					<select id="date" name="date">
						<option value="default"><?php _e( 'Default', 'prosports' ); ?></option>
						<option value=""><?php _e( 'All', 'prosports' ); ?></option>
						<option value="w"><?php _e( 'This week', 'prosports' ); ?></option>
						<option value="day"><?php _e( 'Today', 'prosports' ); ?></option>
					</select>
				</label>
			</p>
			<p>
				<label>
					<?php _e( 'Number of events to show:', 'prosports' ); ?>
					<input type="text" size="3" name="number" id="number" value="5">
				</label>
			</p>
			<p>
				<label>
					<?php _e( 'Sort Order:', 'prosports' ); ?>
					<select id="order" name="order">
						<option value="default"><?php _e( 'Default', 'prosports' ); ?></option>
						<option value="ASC"><?php _e( 'Ascending', 'prosports' ); ?></option>
						<option value="DESC"><?php _e( 'Descending', 'prosports' ); ?></option>
					</select>
				</label>
			</p>
			<p class="sp-prefs">
				<?php _e( 'Columns:', 'prosports' ); ?><br>
				<?php 
				$the_columns = array(
					'event' => __( 'Event', 'prosports' ),
					'teams' => __( 'Teams', 'prosports' ),
					'time' => __( 'Time', 'prosports' ),
					'venue' => __( 'Venue', 'prosports' ),
					'article' => __( 'Article', 'prosports' ),
				);
				$field_name = 'columns[]';
				$field_id = 'columns';
				?>
			...
			<p class="submit">
				<input type="button" class="button-primary" value="<?php echo sprintf( __( 'Insert %s', 'prosports' ), __( 'Shortcode', 'prosports' ) ); ?>" onclick="insertProSports('event_list');" />
				<a class="button-secondary" onclick="tb_remove();" title="<?php _e( 'Cancel', 'prosports' ); ?>"><?php _e( 'Cancel', 'prosports' ); ?></a>
			</p>
		</div>
		<?php
	...
	public function event_blocks_shortcode() {
		...
		<div class="wrap sp-thickbox-content" id="sp-thickbox-event_blocks">
			...
			<p class="submit">
				<input type="button" class="button-primary" value="<?php echo sprintf( __( 'Insert %s', 'prosports' ), __( 'Shortcode', 'prosports' ) ); ?>" onclick="insertProSports('event_blocks');" />
				<a class="button-secondary" onclick="tb_remove();" title="<?php _e( 'Cancel', 'prosports' ); ?>"><?php _e( 'Cancel', 'prosports' ); ?></a>
			</p>
		</div>
		<?php
	...
	public function league_table_shortcode() {
		...
		<div class="wrap sp-thickbox-content" id="sp-thickbox-league_table">
			<p>
				<label>
					<?php printf( __( 'Select %s:', 'prosports' ), __( 'League Table', 'prosports' ) ); ?>
					<?php
					$args = array(
						'post_type' => 'sp_table',
						'name' => 'id',
			...
			<p>
				<label>
					<?php _e( 'Number of teams to show:', 'prosports' ); ?>
					<input type="text" size="3" name="number" id="number" value="5">
				</label>
			</p>
			<p class="sp-prefs">
			...
			<p>
				<label>
					...
					<?php _e( 'Display logos', 'prosports' ); ?>
				</label>
			</p>
			<p>
				<label>
					<input type="checkbox" name="show_full_table_link" id="show_full_table_link">
					<?php _e( 'Display link to view full table', 'prosports' ); ?>
				</label>
			</p>
			<p class="submit">
				<input type="button" class="button-primary" value="<?php echo sprintf( __( 'Insert %s', 'prosports' ), __( 'Shortcode', 'prosports' ) ); ?>" onclick="insertProSports('league_table');" />
				<a class="button-secondary" onclick="tb_remove();" title="<?php _e( 'Cancel', 'prosports' ); ?>"><?php _e( 'Cancel', 'prosports' ); ?></a>
			</p>
		</div>
		<?php
	...
	public function player_details_shortcode() {
		...
		<div class="wrap sp-thickbox-content" id="sp-thickbox-player_details">
			<p>
				<label>
					<?php printf( __( 'Select %s:', 'prosports' ), __( 'Player', 'prosports' ) ); ?>
					<?php
					$args = array(
						'post_type' => 'sp_player',
						'name' => 'id',
			...
			<p class="submit">
				<input type="button" class="button-primary" value="<?php echo sprintf( __( 'Insert %s', 'prosports' ), __( 'Shortcode', 'prosports' ) ); ?>" onclick="insertProSports('player_details');" />
				<a class="button-secondary" onclick="tb_remove();" title="<?php _e( 'Cancel', 'prosports' ); ?>"><?php _e( 'Cancel', 'prosports' ); ?></a>
			</p>
		</div>
		<?php
	...
	public function player_statistics_shortcode() {
		...
		<div class="wrap sp-thickbox-content" id="sp-thickbox-player_statistics">
			...
			<p class="submit">
				<input type="button" class="button-primary" value="<?php echo sprintf( __( 'Insert %s', 'prosports' ), __( 'Shortcode', 'prosports' ) ); ?>" onclick="insertProSports('player_statistics');" />
				<a class="button-secondary" onclick="tb_remove();" title="<?php _e( 'Cancel', 'prosports' ); ?>"><?php _e( 'Cancel', 'prosports' ); ?></a>
			</p>
		</div>
		<?php
	...
	public function player_list_shortcode() {
		...
		<div class="wrap sp-thickbox-content" id="sp-thickbox-player_list">
			<p>
				<label>
					<?php printf( __( 'Select %s:', 'prosports' ), __( 'Player List', 'prosports' ) ); ?>
					<?php
					$args = array(
						'post_type' => 'sp_list',
						'name' => 'id',
			...
			<p>
				<label>
					<?php _e( 'Number of players to show:', 'prosports' ); ?>
					<input type="text" size="3" name="number" id="number" value="5">
				</label>
			</p>
			<p class="sp-prefs">
			...
			<p>
				<label>
					<?php _e( 'Sort by:', 'prosports' ); ?>
					<?php
					$args = array(
						'prepend_options' => array(
							'default' => __( 'Default', 'prosports' ),
							'number' => __( 'Number', 'prosports' ),
							'name' => __( 'Name', 'prosports' ),
							'eventsplayed' => __( 'Played', 'prosports' )
						),
						'post_type' => array( 'sp_metric', 'sp_performance', 'sp_statistic' ),
						'name' => 'orderby',
						'id' => 'orderby',
			...
			<p>
				<label>
					<?php _e( 'Sort Order:', 'prosports' ); ?>
					<select id="order" name="order">
						<option value=""><?php _e( 'Default', 'prosports' ); ?></option>
						<option value="ASC"><?php _e( 'Ascending', 'prosports' ); ?></option>
						<option value="DESC"><?php _e( 'Descending', 'prosports' ); ?></option>
					</select>
				</label>
			...
			<p>
				<label>
					...
					<?php _e( 'Display link to view all players', 'prosports' ); ?>
				</label>
			</p>
			<p class="submit">
				<input type="button" class="button-primary" value="<?php echo sprintf( __( 'Insert %s', 'prosports' ), __( 'Shortcode', 'prosports' ) ); ?>" onclick="insertProSports('player_list');" />
				<a class="button-secondary" onclick="tb_remove();" title="<?php _e( 'Cancel', 'prosports' ); ?>"><?php _e( 'Cancel', 'prosports' ); ?></a>
			</p>
		</div>
		<?php
		...
		<div class="wrap sp-thickbox-content" id="sp-thickbox-player_gallery">
			...
			<p>
				<label>
					...
					<?php _e( 'Display player names on hover', 'prosports' ); ?>
				</label>
			</p>
			<p class="submit">
				<input type="button" class="button-primary" value="<?php echo sprintf( __( 'Insert %s', 'prosports' ), __( 'Shortcode', 'prosports' ) ); ?>" onclick="insertProSports('player_gallery');" />
				<a class="button-secondary" onclick="tb_remove();" title="<?php _e( 'Cancel', 'prosports' ); ?>"><?php _e( 'Cancel', 'prosports' ); ?></a>
			</p>
		</div>
		<?php
