...
function sp_generator_tag( $gen, $type ) {
	switch ( $type ) {
		case 'html':
			$gen .= "\n" . '<meta name="generator" content="ProSports ' . esc_attr( SP_VERSION ) . '">';
			break;
		case 'xhtml':
			$gen .= "\n" . '<meta name="generator" content="ProSports ' . esc_attr( SP_VERSION ) . '" />';
			break;
...
if ( ! function_exists( 'prosports_taxonomy_archive_description' ) ) {
	 ...
	 * @return void
	 */
	function prosports_taxonomy_archive_description() {
...
if ( ! function_exists( 'prosports_output_event_logos' ) ) {
	 ...
	 * @return void
	 */
	function prosports_output_event_logos() {
		sp_get_template( 'event-logos.php' );
	}
}

if ( ! function_exists( 'prosports_output_event_video' ) ) {
	 ...
	 * @return void
	 */
	function prosports_output_event_video() {
		sp_get_template( 'event-video.php' );
	}
}
if ( ! function_exists( 'prosports_output_event_results' ) ) {
	 ...
	 * @return void
	 */
	function prosports_output_event_results() {
		sp_get_template( 'event-results.php' );
	}
}
if ( ! function_exists( 'prosports_output_event_details' ) ) {
	 ...
	 * @return void
	 */
	function prosports_output_event_details() {
		sp_get_template( 'event-details.php' );
	}
}
if ( ! function_exists( 'prosports_output_event_venue' ) ) {
	 ...
	 * @return void
	 */
	function prosports_output_event_venue() {
		sp_get_template( 'event-venue.php' );
	}
}
if ( ! function_exists( 'prosports_output_event_performance' ) ) {
	 ...
	 * @return void
	 */
	function prosports_output_event_performance() {
...
if ( ! function_exists( 'prosports_output_calendar' ) ) {
	 ...
	 * @return void
	 */
	function prosports_output_calendar() {
        $id = get_the_ID();
...
if ( ! function_exists( 'prosports_output_team_link' ) ) {
	 ...
	 * @return void
	 */
	function prosports_output_team_link() {
		sp_get_template( 'team-link.php' );
	}
}
if ( ! function_exists( 'prosports_output_team_logo' ) ) {
	 ...
	 * @return void
	 */
	function prosports_output_team_logo() {
		sp_get_template( 'team-logo.php' );
	}
}
if ( ! function_exists( 'prosports_output_team_details' ) ) {
	 ...
	 * @return void
	 */
	function prosports_output_team_details() {
		sp_get_template( 'team-details.php' );
	}
}
if ( ! function_exists( 'prosports_output_team_tables' ) ) {
	 ...
	 * @return void
	 */
	function prosports_output_team_tables() {
		sp_get_template( 'team-tables.php' );
	}
}
if ( ! function_exists( 'prosports_output_team_lists' ) ) {
	 ...
	 * @return void
	 */
	function prosports_output_team_lists() {
...
if ( ! function_exists( 'prosports_output_league_table' ) ) {
	 ...
	 * @return void
	 */
	function prosports_output_league_table() {
...
if ( ! function_exists( 'prosports_output_player_photo' ) ) {
	 ...
	 * @return void
	 */
	function prosports_output_player_photo() {
		sp_get_template( 'player-photo.php' );
	}
}
if ( ! function_exists( 'prosports_output_player_details' ) ) {
	 ...
	 * @return void
	 */
	function prosports_output_player_details() {
		sp_get_template( 'player-details.php' );
	}
}
if ( ! function_exists( 'prosports_output_player_statistics' ) ) {
	 ...
	 * @return void
	 */
	function prosports_output_player_statistics() {
...
if ( ! function_exists( 'prosports_output_player_list' ) ) {
	 ...
	 * @return void
	 */
	function prosports_output_player_list() {
        $id = get_the_ID();
        $format = get_post_meta( $id, 'sp_format', true );
...
if ( ! function_exists( 'prosports_output_staff_photo' ) ) {
	 ...
	 * @return void
	 */
	function prosports_output_staff_photo() {
		sp_get_template( 'staff-photo.php' );
	}
}
if ( ! function_exists( 'prosports_output_staff_details' ) ) {
	 ...
	 * @return void
	 */
	function prosports_output_staff_details() {
...
function prosports_output_venue_map( $query ) {
    if ( ! is_tax( 'sp_venue' ) )
        return;
...
function prosports_output_br_tag() {
	?>
	<br>
	<?php
}
