...
/**
 * ProSports Date Format - Allows to change date format for everything ProSports
 *
 * @access public
 * @return string
 */
function sp_date_format() {
	return apply_filters( 'prosports_date_format', get_option( 'date_format' ) );
}

/**
 * ProSports Time Format - Allows to change time format for everything ProSports
 *
 * @access public
 * @return string
 */
function sp_time_format() {
	return apply_filters( 'prosports_time_format', get_option( 'time_format' ) );
}
