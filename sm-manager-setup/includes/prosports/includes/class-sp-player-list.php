 ...
 * Player List Class
 *
 * The ProSports player list class handles individual player list data.
 *
...
class SP_Player_List extends SP_Custom_Post {
	...
	public function data( $admin = false ) {
		...
		if ( $admin ):
			...
			$labels['name'] = __( 'Player', 'prosports' );
			if ( in_array( 'team', $this->columns ) ) $labels['team'] = __( 'Team', 'prosports' );
