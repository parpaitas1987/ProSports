<?php
/**
 * ProSports Conditional Functions
 *
...
/**
 * is_prosports - Returns true if on a page which uses ProSports templates
 *
 * @access public
 * @return bool
 */
function is_prosports() {
	return apply_filters( 'is_prosports', ( is_singular( sp_post_types() ) ) ? true : false );
}
...
if ( ! function_exists( 'sp_post_types' ) ) {
	function sp_post_types() {
		return apply_filters( 'prosports_post_types', array( 'sp_event', 'sp_calendar', 'sp_team', 'sp_table', 'sp_player', 'sp_list', 'sp_staff' ) );
	}
}
...
if ( ! function_exists( 'sp_primary_post_types' ) ) {
	function sp_primary_post_types() {
		return apply_filters( 'prosports_primary_post_types',  array( 'sp_event', 'sp_team', 'sp_player', 'sp_staff' ) );
	}
}
...
if ( ! function_exists( 'sp_secondary_post_types' ) ) {
	function sp_secondary_post_types() {
		return apply_filters( 'prosports_secondary_post_types', array_diff( sp_post_types(), sp_primary_post_types() ) );
	}
}
...
if ( ! function_exists( 'sp_config_types' ) ) {
	function sp_config_types() {
		return apply_filters( 'prosports_config_types', array( 'sp_result', 'sp_outcome', 'sp_column', 'sp_performance', 'sp_metric', 'sp_statistic' ) );
	}
}
...
if ( ! function_exists( 'sp_taxonomies' ) ) {
	function sp_taxonomies() {
		return apply_filters( 'prosports_terms', array( 'sp_league', 'sp_season', 'sp_venue', 'sp_position' ) );
	}
}
...
/**
 * is_sp_post_type - Returns true if post is ProSports post type
 *
 * @access public
 * @return bool
 */
...
/**
 * is_sp_config_type - Returns true if post is ProSports config type
 *
 * @access public
 * @return bool
 */
