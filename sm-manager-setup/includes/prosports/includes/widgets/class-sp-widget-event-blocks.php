...
class SP_Widget_Event_Blocks extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'widget_sp_event_blocks', 'description' => __( 'A list of events.', 'prosports' ) );
		parent::__construct('sp_event_blocks', __( 'Event Blocks', 'prosports' ) . ' (' . __( 'ProSports', 'prosports' ) . ')', $widget_ops);
	}
	...
	function widget( $args, $instance ) {
		...
		// Action to hook into
		do_action( 'prosports_before_widget_template', $args, $instance, 'event-blocks' );
		...
		// Action to hook into
		do_action( 'prosports_after_widget_template', $args, $instance, 'event-blocks' );
	...
	function update( $new_instance, $old_instance ) {
		...
		// Filter to hook into
		$instance = apply_filters( 'prosports_widget_update', $instance, $new_instance, $old_instance, 'event-blocks' );
	...
	function form( $instance ) {
		...
		// Action to hook into
		do_action( 'prosports_before_widget_template_form', $this, $instance, 'event-blocks' );
		?>
		...
		<?php
		// Action to hook into
		do_action( 'prosports_after_widget_template_form', $this, $instance, 'event-blocks' );
	}
}
