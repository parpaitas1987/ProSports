...
class SP_Widget_Event_Calendar extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'widget_calendar widget_sp_event_calendar', 'description' => __( 'A calendar of events.', 'prosports' ) );
		parent::__construct('sp_event_calendar', __( 'Event Calendar', 'prosports' ) . ' (' . __( 'ProSports', 'prosports' ) . ')', $widget_ops);
	}
	...
	function update( $new_instance, $old_instance ) {
		...
		// Filter to hook into
		$instance = apply_filters( 'prosports_widget_update', $instance, $new_instance, $old_instance, 'event-calendar' );
