...
class SP_Widget_Player_Gallery extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'widget_player_gallery widget_sp_player_gallery', 'description' => __( 'Display a gallery of players.', 'prosports' ) );
		parent::__construct('sp_player_gallery', __( 'Player Gallery', 'prosports' ) . ' (' . __( 'ProSports', 'prosports' ) . ')', $widget_ops);
	}
	...
	function widget( $args, $instance ) {
		...
		// Action to hook into
		do_action( 'prosports_before_widget_template', $args, $instance, 'player-gallery' );
		...
		// Action to hook into
		do_action( 'prosports_after_widget_template', $args, $instance, 'player-gallery' );
	...
	function update( $new_instance, $old_instance ) {
		...
		// Filter to hook into
		$instance = apply_filters( 'prosports_widget_update', $instance, $new_instance, $old_instance, 'player-gallery' );
	...
	function form( $instance ) {
		...
		// Action to hook into
		do_action( 'prosports_before_widget_template_form', $this, $instance, 'player-gallery' );
		?>
		<p><label for="<?php echo $this->get_field_id('title'); ?>"><?php _e( 'Title:', 'prosports' ); ?></label>
		<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>" /></p>

		<p><label for="<?php echo $this->get_field_id('id'); ?>"><?php printf( __( 'Select %s:', 'prosports' ), __( 'Player List', 'prosports' ) ); ?></label>
		<?php
		$args = array(
			'post_type' => 'sp_list',
		...
		<p><label for="<?php echo $this->get_field_id('number'); ?>"><?php _e( 'Number of players to show:', 'prosports' ); ?></label>
		<input id="<?php echo $this->get_field_id('number'); ?>" name="<?php echo $this->get_field_name('number'); ?>" type="text" value="<?php echo esc_attr($number); ?>" size="3"></p>

		<p><label for="<?php echo $this->get_field_id('columns'); ?>"><?php _e( 'Columns:', 'prosports' ); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('orderby'); ?>"><?php _e( 'Sort by:', 'prosports' ); ?></label>
		<?php
		$args = array(
		...
		<p><label for="<?php echo $this->get_field_id('order'); ?>"><?php _e( 'Sort Order:', 'prosports' ); ?></label>
		<select name="<?php echo $this->get_field_name('order'); ?>" id="<?php echo $this->get_field_id('order'); ?>" class="sp-select-order widefat" <?php disabled( $orderby, 'default' ); ?>>
			<option value="ASC" <?php selected( 'ASC', $order ); ?>><?php _e( 'Ascending', 'prosports' ); ?></option>
			<option value="DESC" <?php selected( 'DESC', $order ); ?>><?php _e( 'Descending', 'prosports' ); ?></option>
		</select></p>
		...
		<label for="<?php echo $this->get_field_id('show_all_players_link'); ?>"><?php _e( 'Display link to view all players', 'prosports' ); ?></label></p>
		...
		<label for="<?php echo $this->get_field_id('show_names_on_hover'); ?>"><?php _e( 'Display player names on hover', 'prosports' ); ?></label></p>

		<?php
		// Action to hook into
		do_action( 'prosports_after_widget_template_form', $this, $instance, 'player-gallery' );
	}
}
