...
class SP_Widget_Countdown extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'widget_countdown widget_sp_countdown', 'description' => __( 'A clock that counts down to an upcoming event.', 'prosports' ) );
		parent::__construct('sp_countdown', __( 'Countdown', 'prosports' ) . ' (' . __( 'ProSports', 'prosports' ) . ')', $widget_ops);
	}
	...
	function update( $new_instance, $old_instance ) {
		...
		// Filter to hook into
		$instance = apply_filters( 'prosports_widget_update', $instance, $new_instance, $old_instance, 'countdown' );
	...
	function form( $instance ) {
		...
		// Action to hook into
		do_action( 'prosports_before_widget_template_form', $this, $instance, 'countdown' );
		?>
		<p><label for="<?php echo $this->get_field_id('title'); ?>"><?php _e( 'Title:', 'prosports' ); ?></label>
		<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>" /></p>

		<p class="sp-dropdown-filter"><label for="<?php echo $this->get_field_id('team'); ?>"><?php printf( __( 'Select %s:', 'prosports' ), __( 'Team', 'prosports' ) ); ?></label>
		<?php
		$args = array(
			'post_type' => 'sp_team',
		...
		<p class="sp-dropdown-target"><label for="<?php echo $this->get_field_id('id'); ?>"><?php printf( __( 'Select %s:', 'prosports' ), __( 'Event', 'prosports' ) ); ?></label>
		<?php
		$args = array(
			'post_type' => 'sp_event',
		...
		if ( ! sp_dropdown_pages( $args ) ):
			sp_post_adder( 'sp_event', __( 'Add New', 'prosports' ) );
		endif;
		?>
		</p>
		...
		<label for="<?php echo $this->get_field_id('show_venue'); ?>"><?php _e( 'Display venue', 'prosports' ); ?></label></p>
		...
		<label for="<?php echo $this->get_field_id('show_league'); ?>"><?php _e( 'Display competition', 'prosports' ); ?></label></p>
		
		<?php
		// Action to hook into
		do_action( 'prosports_after_widget_template_form', $this, $instance, 'countdown' );
	}
}
