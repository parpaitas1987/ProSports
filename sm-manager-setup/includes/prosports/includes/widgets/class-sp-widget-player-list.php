...
class SP_Widget_Player_list extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'widget_player_list widget_sp_player_list', 'description' => __( 'Display a list of players.', 'prosports' ) );
		parent::__construct('sp_player_list', __( 'Player List', 'prosports' ) . ' (' . __( 'ProSports', 'prosports' ) . ')', $widget_ops);
	}
	...
	function widget( $args, $instance ) {
		...
		// Action to hook into
		do_action( 'prosports_before_widget_template', $args, $instance, 'player-list' );
		...
		// Action to hook into
		do_action( 'prosports_after_widget_template', $args, $instance, 'player-list' );
	...
	function update( $new_instance, $old_instance ) {
		...
		// Filter to hook into
		$instance = apply_filters( 'prosports_widget_update', $instance, $new_instance, $old_instance, 'player-list' );
	...
	function form( $instance ) {
		...
		<p class="sp-prefs">
			<?php _e( 'Performance:', 'prosports' ); ?><br>
			<?php 
			$args = array(
