...
class SP_Admin_CPT_Sponsor extends SP_Admin_CPT {
	...
	public function edit_columns( $existing_columns ) {
		...
		$columns = array_merge( array(
			...
			'sp_impressions' => __( 'Impressions', 'prosports' ),
			'sp_clicks' => __( 'Clicks', 'prosports' ),
		), $existing_columns, array(
			'sp_icon' => '<span class="dashicons sp-icon-megaphone tips" title="' . __( 'Logo', 'prosports' ) . '"></span>',
			'title' => __( 'Sponsor', 'prosports' ),
		) );
		return apply_filters( 'prosports_sponsor_admin_columns', $columns );
	}
