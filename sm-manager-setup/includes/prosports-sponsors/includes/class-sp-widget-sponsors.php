...
class SP_Widget_Sponsors extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'widget_sponsors widget_sp_sponsors', 'description' => __( 'A list of sponsors.', 'prosports' ) );
		parent::__construct('sp_sponsors', __( 'Sponsors', 'prosports' ) . ' (' . __( 'ProSports', 'prosports' ) . ')' , $widget_ops);
	}
	...
	function update( $new_instance, $old_instance ) {
		...
		// Filter to hook into
		$instance = apply_filters( 'prosports_widget_update', $instance, $new_instance, $old_instance, 'sponsors' );
	...
	function form( $instance ) {
		...
		// Action to hook into
		do_action( 'prosports_before_widget_template_form', $this, $instance, 'sponsors' );
		?>
		<p><label for="<?php echo $this->get_field_id('title'); ?>"><?php _e( 'Title:', 'prosports' ); ?></label>
		<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>" /></p>

		<p><label for="<?php echo $this->get_field_id('limit'); ?>"><?php _e( 'Number of sponsors to show:', 'prosports' ); ?></label>
		...
		<select name="<?php echo $this->get_field_name('orderby'); ?>" id="<?php echo $this->get_field_id('orderby'); ?>" class="sp-select-orderby widefat">
			<option value="menu_order" <?php selected( 'menu_order', $orderby ); ?>><?php _e( 'Menu Order', 'prosports' ); ?></option>
			<option value="date" <?php selected( 'date', $orderby ); ?>><?php _e( 'Date', 'prosports' ); ?></option>
			<option value="title" <?php selected( 'title', $orderby ); ?>><?php _e( 'Name', 'prosports' ); ?></option>
			<option value="rand" <?php selected( 'rand', $orderby ); ?>><?php _e( 'Random', 'prosports' ); ?></option>
		</select></p>
		...
		<p><label for="<?php echo $this->get_field_id('width'); ?>"><?php _e( 'Max Width:', 'prosports' ); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('height'); ?>"><?php _e( 'Max Height:', 'prosports' ); ?></label>
		...
		<?php
		// Action to hook into
		do_action( 'prosports_after_widget_template_form', $this, $instance, 'sponsors' );
	}
}
